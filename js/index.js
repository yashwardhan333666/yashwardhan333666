...
$(".navigation-content ul li a").hover(function(e) {
   ...
   //NAVIGATION CONTENT 
    ...
    window.onload=function(){
        $('.play-project img').on('click',function(e){
            var project = e.currentTarget.dataset.project;
   
            var songtoplay = document.querySelector(`[data-audio="${project}"]`);
            

            //if project is playing pause it
            ...
            //if project is not playing play it and if another project is playing mute the other project
