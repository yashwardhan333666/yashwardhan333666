...
(function(e, undefined) {
  ...
  (t = x(o)), (function(e, undefined) {
    ...
    try {
      H.apply((A = O.call(v.childNodes)), v.childNodes), A[v.childNodes.length]
        .nodeType;
    } catch (rt) {
      H = {
        apply: A.length
    ...
    function ot() {
      ...
      return (e = function(n, i) {
        return t.push((n += " ")) > r.cacheLength && delete e[t.shift()], (e[
          n
        ] = i);
      });
    }
        ...
        ? (
            ...
            (b.getById = at(function(e) {
              return (f.appendChild(
                e
              ).id = y), !t.getElementsByName || !t.getElementsByName(y).length;
            })),
            b.getById
              ? (
            ...
            (b.qsa = it(t.querySelectorAll)) &&
              (
                at(function(e) {
                  (e.innerHTML =
                    "<select><option selected=''></option></select>"), e.querySelectorAll("[selected]").length || h.push("\\[" + R + "*(?:value|" + P + ")"), e.querySelectorAll(":checked").length || h.push(":checked");
                }),
                at(function(e) {
                  ...
                  t.setAttribute(
                    "type",
                    "hidden"
                  ), e.appendChild(t).setAttribute("t", ""), e.querySelectorAll("[t^='']").length && h.push("[*^$]=" + R + "*(?:''|\"\")"), e.querySelectorAll(":enabled").length || h.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), h.push(",.*:");
                })
              ),
            (b.matchesSelector = it(
              ...
              at(function(e) {
                (b.disconnectedMatch = g.call(
                  e,
                  "div"
                )), g.call(e, "[s!='']:x"), d.push("!=", B);
              }),
              ...
              : function(e, n) {
                  ...
                  if (!o || !s)
                    return e === t
                      ...
                      : n === t
                        ? 1
                        : o ? -1 : s ? 1 : u ? F.call(u, e) - F.call(u, n) : 0;
      ...
      pseudos: {
        ...
        lang: st(function(e) {
          return V.test(e || "") ||
            ut.error(
              "unsupported lang: " + e
            ), (e = e.replace(tt, nt).toLowerCase()), function(t) {
            var n;
            do
              if (
                (n = p
    ...
    function bt(e, t, n, r, i, o) {
      return r && !r[y] && (r = bt(r)), i &&
        !i[y] &&
        (i = bt(i, o)), st(function(o, s, a, u) {
        var l,
          c,
          f,
          p = [],
    ...
    function Nt() {}
    (Nt.prototype = r.filters =
      r.pseudos), (r.setFilters = new Nt()), (b.sortStable =
      y.split("").sort(S).join("") === y), l(), [0, 0].sort(
      S
    ), (b.detectDuplicates = E), at(function(e) {
      if (
        (
    ...
    }), (x.find = ut), (x.expr = ut.selectors), (x.expr[":"] =
      x.expr.pseudos), (x.unique = ut.uniqueSort), (x.text =
        ...
        : this.each(function() {
            if ("string" === n) {
              var o,
                ...
                l = e.match(w) || [];
              while ((o = l[s++]))
                (u = i ? u : !a.hasClass(o)), a[u ? "addClass" : "removeClass"](
                  o
                );
      ...
      if (m && (u = m.events)) {
        ...
        while (l--)
          if (
            ...
            (f = x.event.special[h] || {}), (h =
              (r ? f.delegateType : f.bindType) || h), (p = u[h] || []), (a =
              a[2] &&
              RegExp("(^|\\.)" + d.join("\\.(?:.*\\.|)") + "(\\.|$)")), (s = o =
              p.length);
            while (o--)
    ...
    trigger: function(t, n, r, i) {
      ...
      if (
        ...
        while ((a = h[s++]) && !t.isPropagationStopped())
          (t.type = s > 1 ? l : p.bindType || d), (f =
            (q.get(a, "events") || {})[t.type] && q.get(a, "handle")), f &&
            f.apply(a, n), (f = c && a[c]), f &&
            x.acceptData(a) &&
            f.apply &&
            f.apply(a, n) === !1 &&
            t.preventDefault();
  ...
  (lt.optgroup =
    lt.option), (lt.tbody = lt.tfoot = lt.colgroup = lt.caption = lt.col =
    lt.thead), (lt.th = lt.td), x.fn.extend({
    text: function(e) {
      return x.access(
        this,
        function(e) {
      ...
      for (; f > c; c++)
        if (((i = e[c]), i || 0 === i))
          if ("object" === x.type(i)) x.merge(h, i.nodeType ? [i] : i);
            ...
            (o = o || p.appendChild(t.createElement("div"))), (s = (tt.exec(
              i
            ) || ["", ""])[1]
              .toLowerCase()), (a = lt[s] || lt._default), (o.innerHTML =
              a[1] + i.replace(et, "<$1></$2>") + a[2]), (l = a[0]);
  ...
  x.fn.extend({
    ...
    style: function(e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var i,
          ...
          a = x.camelCase(t),
          u = e.style;
        return (t = x.cssProps[a] || (x.cssProps[a] = Dt(u, a))), (s =
    ...
    css: function(e, t, n, r) {
      var i,
        ...
        s,
        a = x.camelCase(t);
      return (t = x.cssProps[a] || (x.cssProps[a] = Dt(e.style, a))), (s =
        x.cssHooks[t] || x.cssHooks[a]), s &&
        "get" in s &&
        (i = s.get(e, !0, n)), i === undefined &&
        (i = yt(e, t, r)), "normal" === i && t in Et && (i = Et[t]), "" === n ||
      n
  ...
  (x.fn.load = function(e, t, n) {
    ...
    ajax: function(e, t) {
      ...
      (u = c.global), u &&
        ...
        x.event.trigger(
          "ajaxStart"
        ), (c.type = c.type.toUpperCase()), (c.hasContent = !Kt.test(
        c.type
    ...
    return a || "jsonp" === t.dataTypes[0]
      ? (
          ...
          r.always(function() {
            (e[
              i
            ] = o), t[i] && ((t.jsonpCallback = n.jsonpCallback), pn.push(i)), s && x.isFunction(o) && o(s[0]), (s = o = undefined);
          }),
          "script"
        )
      : undefined;
  ...
  e.ActiveXObject &&
    ...
    !!dn &&
    "withCredentials" in
      dn), (x.support.ajax = dn = !!dn), x.ajaxTransport(function(e) {
    var t;
    return x.support.cors || (dn && !e.crossDomain)
      ? {
          send: function(n, r) {
            ...
            }), (s.onload = t()), (s.onerror = t("error")), (t = yn[
              (o = mn++)
  ...
  function Sn(e, t, n) {
    ...
    return En(l, c), x.isFunction(l.opts.start) &&
  ...
  function Dn(e, t, n) {
    ...
    if ((s = g.length)) {
      ...
      for (r = 0; s > r; r++)
        (i = g[r]), (l = p.createTween(i, m ? a[i] : 0)), (d[i] =
          a[i] || x.style(e, i)), i in a ||
          (
            (a[i] = l.start),
            m &&
              (
  ...
  (x.Tween = An), (An.prototype = {
    ...
    run: function(e) {
      ...
      n.set
        ? n.set(this)
        : An.propHooks._default.set(this), this;
    }
  ...
  x.each(
    ...
    setOffset: function(e, t, n) {
      var r,
        ...
        p = {};
      "static" === c &&
        (e.style.position = "relative"), (a = f.offset()), (o = x.css(
        e,
        "top"
      )), (u = x.css(e, "left")), (l =
