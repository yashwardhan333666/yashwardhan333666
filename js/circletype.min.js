  ...
  return (function(t) {
    ...
    function(t, n, e) {
      var r = e(1),
        ...
        a = function(t, n, e) {
          ...
          for (f in (v && (e = n), e))
            (l = ((s = !h && g && void 0 !== g[f]) ? g : e)[f]), (p =
              m && s
                ? c(l, r)
                : y && "function" == typeof l ? c(Function.call, l) : l), g &&
              u(g, f, l, t & a.U), _[f] != l && o(_, f, p), y &&
              x[f] != l &&
              (x[f] = l);
        };
    ...
    function(t, n, e) {
      ...
      (e(2).inspectSource = function(t) {
        ...
        f && (o(e, "name") || i(e, "name", n)), t[n] !== e &&
          (
            f && (o(e, u) || i(e, u, t[n] ? "" + t[n] : a.join(String(n)))),
            t === r
              ? (t[n] = e)
              : c ? (t[n] ? (t[n] = e) : i(t, n, e)) : (delete t[n], i(t, n, e))
          );
        ...
        return function(n, e) {
          ...
          return a < 0 || a >= f
            ...
            : (o = c.charCodeAt(a)) < 55296 ||
              ...
              u > 57343
              ? t ? c.charAt(a) : o
              : t ? c.slice(a, a + 2) : u - 56320 + ((o - 55296) << 10) + 65536;
        };
      };
    },
    function(t, n, e) {
      ...
      var r = e(5),
        ...
        a = function() {
          var t,
            ...
            r = o.length;
          for (
            n.style.display = "none", e(45).appendChild(n), n.src =
              "javascript:", (t = n.contentWindow.document).open(), t.write(
        ...
        v = (function() {
          function t(n, e) {
            !(function(t, n) {
              ...
              this,
              t
            ), (this.element = n), (this.originalHTML = this.element.innerHTML);
            var o = document.createElement("div"),
              u = document.createDocumentFragment();
            o.setAttribute("aria-label", n.innerText), (o.style.position =
              "relative"), (this.container = o), (this._letters = (function(
              t,
              n
            ) {
            ...
            }), o.appendChild(u), (this.element.innerHTML =
              ""), this.element.appendChild(o);
            var c = window.getComputedStyle(this.element),
              a = c.fontSize,
              f = c.lineHeight;
            (this._fontSize = parseFloat(a)), (this._lineHeight =
              parseFloat(f) ||
              this._fontSize), (this._metrics = this._letters.map(r));
            ...
            (this._minRadius =
              s / l / 2 +
              this
                ._lineHeight), (this._dir = 1), (this._forceWidth = !1), (this._forceHeight = !0), (this._radius = this._minRadius), this._invalidate();
          }
          var n, e, o;
          return (n = t), (e = [
            {
                    ...
                    this._letters.forEach(function(n, r) {
                      var o = n.style,
                        ...
                        a = "translateX("
                          ...
                          .concat(u, "deg)");
                      (o.position =
                        "absolute"), (o.bottom = -1 === e ? 0 : "auto"), (o.left = "50%"), (o.transform = a), (o.transformOrigin = i), (o.webkitTransform = a), (o.webkitTransformOrigin = i);
                    }),
                    this._forceHeight
                  )
                ) {
